...
var in_memory_data_service_1 = require("../app/in-memory-data.service");
var forms_1 = require("@angular/forms");
var login_component_1 = require("./authentication/login.component");
var login_routing_module_1 = require("./authentication/login-routing.module");
var app_routing_module_1 = require("../app/app-routing.module");
var pokemons_module_1 = require("../app/pokemons/pokemons.module");
var app_component_1 = require("../app/app.component");
var page_not_found_component_1 = require("../app/page-not-found.component");
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        core_1.NgModule({
            ...
            providers: [
                platform_browser_1.Title // on fournis le service 'Title' à l'ensemble de l'application 
            ],
